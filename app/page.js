...
return(
    <div className="grid mt-9 grid-cols-2 md:grid-cols-4 gap-3 w-1/2 relative left-1/2 -translate-x-1/2">
        ...
        <Link href={"/games/anticipation"} className="btn btn-active btn-secondary text-white md:col-start-2">🤯 Anticipated</Link>
